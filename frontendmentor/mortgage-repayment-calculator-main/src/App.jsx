...
function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 lg:p-8">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden lg:flex">
        {/* Left side - Form */}
        <div className="lg:w-1/2 p-6 lg:p-10">
          ...
          <form onSubmit={calculateRepayments}>
            ...
            <div className="mb-6">
              ...
              {errors.amount && (
                <p className="text-red text-sm mt-2">{errors.amount}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                {errors.term && (
                  <p className="text-red text-sm mt-2">{errors.term}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative flex items-center border rounded-md overflow-hidden border-slate-300 bg-slate-100 opacity-60">
                  <input
                    ...
                    placeholder="0"
                  />
                  <span className="px-4 py-3 font-bold transition-colors whitespace-nowrap flex-shrink-0 bg-slate-200 text-slate-500">
                    %
                  </span>
                </div>
                {errors.rate && (
                  <p className="text-red text-sm mt-2">{errors.rate}</p>
                )}
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              >
                ...
                <span className="ml-4 text-slate-900 font-bold">Repayment</span>
              </div>
              ...
              >
                ...
                <span className="ml-4 text-slate-500 font-bold">Interest Only</span>
              </div>

              {errors.type && (
                <p className="text-red text-sm mt-2">{errors.type}</p>
              )}
            </div>
            ...
            <button
              type="submit"
              className="w-full lg:w-auto px-10 py-4 bg-lime text-slate-900 font-bold rounded-full flex items-center justify-center gap-3 hover:bg-lime/80 transition-colors"
            >
        ...
        {/* Right side - Results */}
        <div className="lg:w-1/2 bg-slate-900 p-6 lg:p-10 lg:rounded-bl-[80px] flex">
          {!results ? (
            // Empty State
            <div className="text-center w-full my-auto">
              <div className="mb-4 flex justify-center">
                <img src="./assets/images/illustration-empty.svg" alt="" className="w-48" />
              </div>
            ...
            <div className="w-full">
              ...
              <div className="bg-black/25 rounded-lg p-6 border-t-4 border-lime">
                <div className="mb-6">
                  ...
                  <p className="text-lime text-5xl font-bold">£{results.monthlyPayment}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-white text-2xl font-bold">£{results.totalRepayment}</p>
                </div>
              </div>
            </div>
          )}
